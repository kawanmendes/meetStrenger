...
import { claySoft, clayMedium } from '../tokens/shadows';

// Define variantes do input
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        style={[
          styles.input,                  // Base
          styles[variant],               // Variante (default ou clay)
          isFocused && styles[`${variant}Focused`], // Borda ativa
...
const styles = StyleSheet.create({
  ...
  label: {
    ...
    color: colors.textPrimary,   // Cor padrão
  ...
  // Variante DEFAULT
  default: {
    borderColor: colors.border,       // Borda padrão
    borderWidth: 1,                   // Espessura normal
  },

  // Variante CLAY (claymorphism)
  clay: {
    borderWidth: 0,                   // Sem borda
    borderColor: 'transparent',
    ...claySoft,                      // Sombra clay suave
    shadowColor: 'rgba(0, 0, 0, 0.08)',
  },

  // Estado focado - DEFAULT
  defaultFocused: {
